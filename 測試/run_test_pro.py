...
test_case = sys.argv[1] if len(sys.argv) > 1 else "ty25-us-002"

print("==================================================")
print(f"🚀 Re-running {test_case} with Gemini 2.5 Pro")
print("📌 Model Specified: gemini-2.5-pro")
print("📌 0 = NA Matching Rule: Active")
print("==================================================")

start_t = time.time()
comp = batch_federal_runner.process_single_test_case(test_case)
...
print(f"\n✅ Completed {test_case} in {elapsed:.1f}s")
