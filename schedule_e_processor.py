...
SCHEMA_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "docs", "how_to_fill_forms_docs", "schedule_e", "schedule_e_schema.json"))
...
def calculate_schedule_e_dynamic(inputs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    res = calculate_schedule_e_part1_v1(v1_inputs)
