...
def run_full_benchmark():
    ...
    target_cases = [
        "restricted_property_83b_election_001",
        "misc_income_barter_canceled_debt_001",
        "repayment_over_3000_credit_method",
        "alex_chen_self_employment_bonus_2024"
    ]
